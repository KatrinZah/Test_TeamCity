...
mkdir config
cp /Users/katrinzaharova/Documents/GitHub/Test/teamcity-testing-framework/infra/browsers.json config/
...
mvn test -Dtest=TeamCityAgentTest#setupTeamCityAgentTest
